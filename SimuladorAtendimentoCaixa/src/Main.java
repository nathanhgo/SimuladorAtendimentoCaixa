...
public class Main {
    ...
    System.out.printf("Media dos tempos de atendimento (%.0f simulaes): %.3f min%n", (double) NUMERO_SIMULACOES, media);
    System.out.printf("Desvio-padro das medias: %.3f min%n", dp);
    }
